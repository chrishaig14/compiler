...
static Object v7(new Integer(7));
...
TEST(vm_test, stack_integration) {
    ObjectStack stack;
    Object value_4(new Integer(4));
    Object value_5(new Integer(5));
    Object value_2(new Integer(2));
    Object value_3(new Integer(3));
    Object value_1(new Integer(1));
