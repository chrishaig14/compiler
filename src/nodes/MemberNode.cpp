...
MemberNode::MemberNode(Node* parent, const std::string& child) : parent(parent), s_child(child) {
    this->ntype = MEMBER;
    this->type = MemberType::STR;
}

MemberNode::MemberNode(Node* parent, int child) : parent(parent), n_child(child) {
    this->ntype = MEMBER;
