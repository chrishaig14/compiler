...
public:
    ...
    OutputCode transpile_object_member(ObjectMemberSNode& node);

    OutputCode transpile_while(WhileSNode& node);

    OutputCode transpile_list(ListSNode& node);

    OutputCode transpile_if(IfSNode& node);

    OutputCode transpile_break(BreakSNode& node);

    OutputCode transpile_continue(ContinueSNode& node);

    OutputCode transpile_match(MatchSNode& node);

    OutputCode transpile_enum_member(EnumMemberSNode& node);

    OutputCode transpile_ternary(TernarySNode& node);

    OutputCode transpile_none(NoneSNode& nn);

    OutputCode transpile_dict(DictSNode& node);
    OutputCode transpile_try_catch(TryCatchSNode& node);
