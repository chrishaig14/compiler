...
Return::Return(ast::UExpNode& expression, TextPosition start, TextPosition end) : ast::Statement(StatementType::RETRN, start, end),
                                                                          expression(std::move(expression)) {
}

bool Return::equal(const ast::Statement& x) const {
