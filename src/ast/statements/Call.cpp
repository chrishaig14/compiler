...
Call::Call(ast::UExpNode function, ast::VectorOfExpNodesU arguments, TextPosition start, TextPosition end) : ast::Statement(StatementType::CALL,
                                                                                                                            start,
                                                                                                                            end),
                                                                                             _function(std::move(
                                                                                                     function)),
...
bool Call::equal(const ast::Statement& x) const {
