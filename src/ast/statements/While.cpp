...
While::While(ast::UExpNode& condition, std::unique_ptr<ast::Block>& body, TextPosition start, TextPosition end) : ast::Statement(
        StatementType::WHIL,
        start,
...
bool While::equal(const ast::Statement& x) const {
