...
Number::Number(NumberType num_type, std::string str, TextPosition start, TextPosition end) : ExpNode(ExpNodeType::NUMBER,
                                                                                                  start,
                                                                                                  end) {
...
bool Number::equal(const ast::ExpNode& x) const {
    auto& other = (Number&) x;
