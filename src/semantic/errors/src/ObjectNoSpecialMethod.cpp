...
#include "../include/ObjectNoSpecialMethod.h"
#include <simple_nodes/common/include/TypeObject.h>

using namespace error;

Error* ObjectNoSpecialMethod::clone() const {
    return new ObjectNoSpecialMethod(*this->type, this->method_name, this->node);
}

bool ObjectNoSpecialMethod::equal(const Error& other) const {
    auto& o = (const ObjectNoSpecialMethod&) other;
...
std::string ObjectNoSpecialMethod::to_str(const CodeLines& code) const {
